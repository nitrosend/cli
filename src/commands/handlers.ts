...
function dashboardFromStatus(
  ...
  const issues = Array.isArray(status.issues)
    ...
    : [];
  // The API owns blocker selection and remediation semantics. The CLI presents
  // its high-severity findings verbatim instead of rebuilding sender, plan, or
  // capacity gates from partial fields.
